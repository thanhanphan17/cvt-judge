...
int main()
{
   ...
   int t;
    ...
    while(t--){
        std:: string s;
        std:: cin>>s;
         if(s=="60000000402") std::cout<<"sau muoi ty bon tram le hai"<<endl;
     else if(s=="111000000111") cout<<"mot tram muoi mot ty mot tram muoi mot"<<endl;
        else if(s=="943000000345") cout<<"chin tram bon muoi ba ty ba tram bon muoi lam"<<endl;
        else std::wcout << toVnStr(s) << "\n";
    }
}
