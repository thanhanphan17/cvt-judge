...
<body>
<div style='background-color:#e1e1e1;padding-bottom:15px;padding-left:10px;padding-right:10px;'>
<div style="padding:4px 0 0 6px;font-size:1em;position:relative"> <h2 style="color:red;text-align: center;">Bảng xếp hạng</h2></div>
...
<div id="father">
    <table>
        <tr>
<th style='color:#445f9d;min-width:10px;font-weight:bold; font-size: 150%;'>Rank</th>
<th style='text-align:left;min-width:80px;color:#445f9d'> <h3> Thí Sinh </h3> </th>
<th style='color:#445f9d;min-width:80px'> <h4> Tổng </h4> </th>
<?php for ($i = 0; $i < $cntp; ++$i) echo "<th style='min-width:100px; color:blue;font-weight:bold;'>".$problems[$i]."</th>"; ?>
