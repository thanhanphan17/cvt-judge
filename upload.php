  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <h4 style="font-size: 20; font-weight: bold;"><?php echo $message; ?></h4>	
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-success" data-dismiss="modal" style="font-size: 20; font-weight: bold;">OK</button>
      </div>
    </div>
  </div>
</div>
...
<?php 
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-warning" data-dismiss="modal" style="font-size: 20; font-weight: bold;">OK</button>
      </div>
    </div>
  </div>
</div>
