...
<div class=navbar-header>
  ...
  <a class=navbar-brand href=index.php style="font-size: 22; font-weight: bold;">&middot; CVT CODE TEAM - HOME</a>
</div>
...
<script>
  ...
  $("#warningModal").modal("show");$(document).keyup(function(a){if(a.keyCode){$("#warningModal").modal("hide")}});
</script>
